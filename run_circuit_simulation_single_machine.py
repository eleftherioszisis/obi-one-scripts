...
CONFIG_ID = "5fc5b0ec-8feb-469e-bea1-aecdac9eca3d"
...
def create_config(manager):
    ...
    circuit_id = "a581a7d9-435e-4aa6-8f27-b0fcb13ec66c"
    ...
    campaign = db_client.register_entity(
        entity=models.SimulationCampaign(
            name="Test Campaign Single Job Neurodamus",
            description="Test Campaign Single Job Neurodamus",
    ...
    simulation = db_client.register_entity(
        entity=models.Simulation(
            name="Test Simulation Single Job Neurodamus",
            description="Test Simulation Single Job Neurodamus",
...
if __name__ == "__main__":
    ...
    manager.monitor_task(task=task, check_mode="stream")
